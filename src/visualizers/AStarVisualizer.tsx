...
import { generatePathfindingGrid, aStar } from '../algorithms/pathfinding'
...
export default function AStarVisualizer({ state, setState }: AStarVisualizerProps) {
  ...
  useEffect(() => {
    if (state.isPlaying) {
      ...
      if (!generatorRef.current) {
        ...
        generatorRef.current = aStar(grid, startRow, startCol, endRow, endCol)
      }
  ...
  return (
    <div className="visualizer">
      ...
      <Grid grid={grid} onCellClick={handleCellClick} onCellDrag={handleCellDrag} onMoveStartEnd={handleMoveStartEnd} showValues={false} />
    </div>
  )
}
