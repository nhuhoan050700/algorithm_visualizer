...
import { generatePathfindingGrid, dfs } from '../algorithms/pathfinding'
...
export default function DFSVisualizer({ state, setState }: DFSVisualizerProps) {
  ...
  return (
    <div className="visualizer">
      <div className="visualizer-controls">
        ...
        <div className="size-control">
          <label htmlFor="dfs-speed-slider">Speed:</label>
          <input
            id="dfs-speed-slider"
            type="range"
            min="0"
