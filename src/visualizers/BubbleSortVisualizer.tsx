...
import { generateRandomArray, bubbleSort } from '../algorithms/bubbleSort'
...
export default function BubbleSortVisualizer({ state, setState }: BubbleSortVisualizerProps) {
  ...
  useEffect(() => {
    if (state.isPlaying) {
      if (!generatorRef.current) {
        ...
        generatorRef.current = bubbleSort(arr)
      }
  ...
  return (
    <div className="visualizer">
      <div className="visualizer-controls">
        ...
        <div className="size-control">
          <label htmlFor="bubble-speed-slider">Speed:</label>
          <input
            id="bubble-speed-slider"
            type="range"
            min="0"
            max="100"
            value={state.speed}
